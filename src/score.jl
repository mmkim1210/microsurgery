...
begin
    ...
    for i in 1:6
        ...
        if i <= 3
            ...
            [lines!(axs[1, mod1(i, 3)], [0, 1], [pre[j, i + 1], post[j, i + 1]], color = ("#2774AE", 0.5)) for j in 1:n] # #CB3C33
            ...
            [lines!(axs[2, mod1(i, 3)], [0, 1], [pre[j, i + 1], post[j, i + 1]], color = ("#2774AE", 0.5)) for j in 1:n] # #CB3C33
    ...
    [lines!(ax, [0, 1], [pre[j, 8], post[j, 8]], color = ("#2774AE", 0.5)) for j in 1:n]
    text!(ax, 0.85, 1.5, text = "p = " * p, align = (:center, :top), textsize = 15)
    ylims!(ax, 0.75, 5.25)
    xlims!(ax, -0.25, 1.25)
...
begin
    ...
    for i in 1:6
        ...
        if i <= 2
            ...
            [lines!(axs[1, mod1(i, 2)], [0, 1], [pre[j, i + 1], post[j, i + 1]], color = ("#2774AE", 0.5)) for j in 1:n] # #CB3C33
        ...
        elseif i <= 4
            ...
            [lines!(axs[2, mod1(i, 2)], [0, 1], [pre[j, i + 1], post[j, i + 1]], color = ("#2774AE", 0.5)) for j in 1:n] # #CB3C33
            ...
            [lines!(axs[3, mod1(i, 2)], [0, 1], [pre[j, i + 1], post[j, i + 1]], color = ("#2774AE", 0.5)) for j in 1:n] # #CB3C33
